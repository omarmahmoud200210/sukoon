...
tagsRouter.post("/", validation(createTagSchema), tryCatch(tagsController.create));
tagsRouter.patch("/:id", validation(updateTagSchema), tryCatch(tagsController.update));
tagsRouter.delete("/:id", tryCatch(tagsController.delete));
tagsRouter.post("/:id/tasks/:taskId", tryCatch(tagsController.addToTask));
tagsRouter.delete("/:id/tasks/:taskId", tryCatch(tagsController.removeFromTask));
