...
class TagService {
    ...
    async getAllTags(userId) {
        return this.tagRepository.getAllTags(userId);
    }
    async getTagById(id, userId) {
        return this.tagRepository.getTagById(id, userId);
    }
    async createTag(userId, name) {
        ...
        return this.tagRepository.createTag(userId, name);
    }
    async updateTag(id, userId, name) {
        ...
        return this.tagRepository.updateTag(id, userId, name);
    }
    async deleteTag(id, userId) {
        return this.tagRepository.deleteTag(id, userId);
    }
    async addTagToTask(tagId, taskId, userId) {
        return this.tagRepository.addTagToTask(tagId, taskId, userId);
    }
    async removeTagFromTask(tagId, taskId, userId) {
        return this.tagRepository.removeTagFromTask(tagId, taskId, userId);
    }
    async getTasksByTag(tagId, userId) {
        return this.tagRepository.getTasksByTag(tagId, userId);
    }
}
