...
tafreeghRouter.post("/", validation(createTafreeghSchema), tryCatch(tafreeghController.create));
tafreeghRouter.patch("/:id", validation(updateTafreeghSchema), tryCatch(tafreeghController.update));
